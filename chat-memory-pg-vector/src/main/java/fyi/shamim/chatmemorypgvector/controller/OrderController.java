...
import fyi.shamim.chatmemorypgvector.tools.OrderStatusTools;
...
public class OrderController {
    ...
    public ResponseEntity<?> orderStatus(@RequestBody String message, @RequestHeader String userId) {
        ...
        chatMemory.get(userId).forEach(m -> log.info("UserID: {}, Message: {}", userId, m));
        ...
        String chatResponse = chatClientWithMemory.prompt()
                .system(systemMsg)
                .user(userMsg)
