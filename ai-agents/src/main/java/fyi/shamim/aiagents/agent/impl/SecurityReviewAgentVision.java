package fyi.shamim.aiagents.agent.impl;

import fyi.shamim.aiagents.agent.SecurityReviewAgent;
import fyi.shamim.aiagents.agent.record.Plan;
import fyi.shamim.aiagents.agent.util.ToolResponseParser;
import fyi.shamim.aiagents.dto.ReviewStateDto;
import fyi.shamim.aiagents.exception.ToolExecutionException;
import fyi.shamim.aiagents.tool.diagram.DiagramTool;
import fyi.shamim.aiagents.tool.posture.PostureTool;
import fyi.shamim.aiagents.tool.rag.RagTool;
import fyi.shamim.aiagents.tool.web.WebTool;
...
public class SecurityReviewAgentVision implements SecurityReviewAgent {
    ...
    public SecurityReviewAgentVision(ToolResponseParser toolResponseParser,
        ...
        this.allTools = ToolCallbacks.from(diagramTool, ragTool, webTool, postureTool);
        this.followUpTools = ToolCallbacks.from(ragTool, webTool, postureTool);
    }

    @Override
    public String execute(ReviewStateDto reviewState) {
    ...
    private Prompt executeToolCalls(String id, ChatResponse chatResponse, Prompt prompt,
