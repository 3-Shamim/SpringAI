...
public class SecurityReviewAgentChainWorkflow implements SecurityReviewAgent {
    ...
    public SecurityReviewAgentChainWorkflow(@Qualifier("chatClient") ChatClient chatClient,
        ...
        this.diagramTools = ToolCallbacks.from(diagramTool);
        this.postureTools = ToolCallbacks.from(postureTool);
        this.ragTools = ToolCallbacks.from(ragTool);
        this.webTools = ToolCallbacks.from(webTool);
