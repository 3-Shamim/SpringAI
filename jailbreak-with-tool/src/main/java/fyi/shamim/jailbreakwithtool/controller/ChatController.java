package fyi.shamim.jailbreakwithtool.controller;

import fyi.shamim.jailbreakwithtool.tools.BankAccountTool;
...
public class ChatController {
    ...
    private final BankAccountTool bankAccountTool;

    @PostMapping
    public ResponseEntity<?> chatWithOpenAI(@RequestBody String text) {

        String system = """
                You are a meeting summarizer specialist.
                """;
